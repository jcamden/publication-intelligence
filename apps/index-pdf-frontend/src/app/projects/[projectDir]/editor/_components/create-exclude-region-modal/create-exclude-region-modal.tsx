...
export type CreateExcludeRegionModalProps = {
	open: boolean;
	onClose: () => void;
	projectId: string;
	currentPage: number;
...
export const CreateExcludeRegionModal = ({
	open,
	onClose,
	projectId,
	currentPage,
					...
					{(field) => (
						<Field>
							...
							<Input
								...
								placeholder="e.g., Header, Footer, Margin"
							/>
