# Phase 6: Region System - Testing Checklist

**Status:** ✅ Implementation Complete - Testing Pending  
**Related:** [Phase 6 Implementation](./phase-6-region-system.md)
...
- [ ] **Expected:** Modal opens immediately after release with "Create Region" title
...
- [ ] Submit form
- [ ] **Expected:** Region created for current page only
...
- [ ] **Expected:** Context visible in Page Sidebar
- [ ] Navigate to page 5
- [ ] **Expected:** Region NOT visible in Page Sidebar
- [ ] Navigate to page 6
- [ ] **Expected:** Context visible in Page Sidebar
- [ ] Navigate to page 3
- [ ] **Expected:** Region NOT visible in Page Sidebar (before start page)
...
- [ ] **Expected:** Context visible in Page Sidebar
- [ ] Navigate to page 10
- [ ] **Expected:** Region NOT visible (after end page)
- [ ] Navigate to pages 3, 5, 7, 9
- [ ] **Expected:** Region NOT visible (odd pages)
...
- [ ] Submit form
- [ ] **Expected:** Region created with green color
- [ ] Check PDF viewer
- [ ] **Expected:** Region rendered with green background
...
- [ ] Verify names are displayed correctly for all regions
...
- [ ] Check PDF viewer
- [ ] **Expected:** Region no longer rendered
- [ ] Check Page Sidebar
- [ ] **Expected:** Region still listed (visibility is separate from page config)
- [ ] Click eye icon again
- [ ] **Expected:** Icon changes back to "eye" (open)
- [ ] **Expected:** Region rendered again on PDF
...
- [ ] Hide second context
- [ ] **Expected:** No regions visible on PDF
- [ ] Show both contexts
- [ ] **Expected:** Both regions rendered (may overlap)
...
- [ ] **Expected:** Modal opens with title "Edit Region" (not "Create Region")
...
- [ ] Check PDF viewer
- [ ] **Expected:** Region now rendered with blue background
...
- [ ] **Expected:** Region no longer visible in Page Sidebar
- [ ] **Expected:** Region no longer rendered on PDF
...
- [ ] Create region with "Every other, starting on 5"
...
- [ ] Create region with "Every other, starting on 4"
...
- [ ] Create region with "Every other, starting on 2, ending on 8"
...
- [ ] **Expected:** Region still exists in Project Sidebar
- [ ] **Expected:** Context renders on PDF
...
- [ ] Edit region in Project Sidebar
- [ ] **Expected:** Page Sidebar updates immediately
- [ ] Delete context in Project Sidebar
- [ ] **Expected:** Page Sidebar updates immediately

### Name Field in Database
- [ ] Create region with name "Test Context"
- [ ] Open browser dev tools → Network tab
- [ ] Observe tRPC response from `region.list`
...
- [ ] **Expected:** Region no longer appears in Page Sidebar for page 5
...
- [ ] Create region with "This page only" on page 3
- [ ] Click "Remove from this page" button
- [ ] **Expected:** Confirmation dialog: "Removing the last page from a region will delete it. Are you sure you'd like to proceed?"
- [ ] Click "Cancel"
- [ ] **Expected:** Context not deleted
- [ ] Click "Remove from this page" again, click "OK"
- [ ] **Expected:** Context deleted entirely (soft delete)
- [ ] Check Project Sidebar
- [ ] **Expected:** Region no longer listed
- [ ] **Implementation Note:** Uses `deleteRegion` mutation for "this_page" regions, `updateRegion` with `exceptPages` for multi-page regions
...
- [ ] Create region with "All pages except 3, 7"
- [ ] Open Edit Context modal
...
- [ ] Create region with "Custom pages: 1-10"
- [ ] Open Edit Context modal
...
- [ ] Create region with "All pages except 3, 5, 7"
- [ ] Check Project Sidebar
- [ ] **Expected:** Page config summary shows "All pages except 3, 5, 7"
- [ ] Create region with "Every other starting on 1, except 3, 7"
- [ ] **Expected:** Summary shows something like "(every other, 1-[last page]) except 3, 7"
- [ ] Create region with "Custom: 1-10,20-30 except 5, 25"
- [ ] **Expected:** Summary shows "1-10, 20-30 except 5, 25"
- [ ] **Implementation Note:** Summary generation uses `getPageConfigSummary()` from `@pubint/core/region.utils.ts`
...
- [ ] Create page_number region "Top-right PN" with "All pages"
- [ ] Navigate to page 5
- [ ] Draw second page_number region region
...
- [ ] **Expected:** Conflict warning appears inline in the modal (replacing form fields):
  ...
  - Shows conflicting region names
...
- [ ] Click "Cancel"
- [ ] **Expected:** Warning disappears, form fields reappear, region not created
- [ ] Submit again, click "Save Anyway"
- [ ] **Expected:** Region created despite conflicts
- [ ] **Implementation Note:** Warning replaces form content, footer buttons hidden during warning

### Conflict Display - Project Sidebar
- [ ] After creating conflicting regions from previous test
- [ ] Open Project Sidebar
- [ ] **Expected:** Both regions show conflicts below them (inline, comma-separated):
...
- [ ] Create page_number region "Even pages PN" with "Every other starting on 2"
- [ ] Create page_number region "All pages PN" with "All pages"
...
- [ ] Create page_number region "Custom PN" with "Custom: 1-5, 10-15"
- [ ] Create page_number region "Overlapping PN" with "Custom: 3-8"
...
### No Conflict for Exclude Regions
- [ ] Create exclude region "Header" with "All pages"
- [ ] Create exclude region "Footer" with "All pages"
- [ ] **Expected:** NO conflict warning (ignore regions can overlap)
- [ ] Navigate to any page
- [ ] **Expected:** Both regions visible, no conflict warning
- [ ] Check Project Sidebar
- [ ] **Expected:** No conflict indicators for exclude regions

### Edit Context to Create Conflict
- [ ] Create page_number region "PN 1" with "Custom: 1-5"
- [ ] Create page_number region "PN 2" with "Custom: 10-15"
...
- [ ] With conflicting regions from previous test
...
- [ ] Create region with "All pages except 1-200" (all pages excluded)
...
- [ ] Create 3+ page_number regions all applying to same page
- [ ] **Expected:** Conflict warning lists all 3+ contexts
- [ ] Delete one conflicting region
- [ ] **Expected:** Conflicts update immediately (fewer conflicts or resolved)
- [ ] Create page_number region that conflicts on page 1 only
...
- [ ] Update phase-6-region-system.md if implementation differs from spec
