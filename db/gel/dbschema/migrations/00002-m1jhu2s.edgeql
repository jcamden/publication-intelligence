CREATE MIGRATION m1jhu2sl7mrnmwpo3353zcitnmqrhyszaw7mi4vjc5s3lvf3xtvmca
    ONTO m1nq2rdpgtuth37tesb2qi4nbpzxcmvpesfxb64cnxmkkqfyrzl5ba
{
  ...
  CREATE TYPE default::Project {
      ...
      CREATE ACCESS POLICY collaborator_full_access
          ALLOW ALL USING (EXISTS ((GLOBAL default::current_user IN .collaborators)));
  ...
  ALTER TYPE default::DocumentPage {
      CREATE ACCESS POLICY project_collaborator_access
          ALLOW ALL USING (EXISTS ((GLOBAL default::current_user IN .document.project.collaborators)));
      CREATE ACCESS POLICY project_owner_access
          ALLOW ALL USING ((.document.project.owner ?= GLOBAL default::current_user));
  ...
  CREATE TYPE default::Event {
      ...
      CREATE ACCESS POLICY project_collaborator_access
          ALLOW ALL USING (EXISTS ((GLOBAL default::current_user IN .project.collaborators)));
      CREATE ACCESS POLICY project_owner_access
  ...
  CREATE TYPE default::IndexRelation {
      ...
      CREATE ACCESS POLICY project_members_read
          ALLOW SELECT USING (((.from_entry.project.owner ?= GLOBAL default::current_user) OR EXISTS ((GLOBAL default::current_user IN .from_entry.project.collaborators))));
      CREATE ACCESS POLICY project_members_write
          ALLOW UPDATE, DELETE, INSERT USING (((.from_entry.project.owner ?= GLOBAL default::current_user) OR EXISTS ((GLOBAL default::current_user IN .from_entry.project.collaborators))));
  ...
  CREATE TYPE default::IndexVariant {
      ...
      CREATE ACCESS POLICY project_members_read
          ALLOW SELECT USING (((.entry.project.owner ?= GLOBAL default::current_user) OR EXISTS ((GLOBAL default::current_user IN .entry.project.collaborators))));
      CREATE ACCESS POLICY project_members_write
          ALLOW UPDATE, DELETE, INSERT USING (((.entry.project.owner ?= GLOBAL default::current_user) OR EXISTS ((GLOBAL default::current_user IN .entry.project.collaborators))));
  ...
  CREATE TYPE default::LLMRun {
      ...
      CREATE ACCESS POLICY document_project_access
          ALLOW SELECT USING ((EXISTS (.document) AND ((.document.project.owner ?= GLOBAL default::current_user) OR EXISTS ((GLOBAL default::current_user IN .document.project.collaborators)))));
  ...
  CREATE TYPE default::Workspace {
      ...
      CREATE ACCESS POLICY member_full_access
          ALLOW ALL USING (EXISTS ((GLOBAL default::current_user IN .members)));
      CREATE ACCESS POLICY others_no_access
          DENY ALL ;
      CREATE REQUIRED LINK owner: default::User {
          ON TARGET DELETE DELETE SOURCE;
