...
export const ResizableSidebar = ({
	...
	return (
		<div
			className="relative flex-shrink-0 border-neutral-200 dark:border-neutral-700"
			style={{ width: `${width}rem` }}
		>
			{children}

			{/* biome-ignore lint/a11y/useFocusableInteractive: resize handle controlled by mouse */}
			{/* biome-ignore lint/a11y/useSemanticElements: div required for positioning */}
			<div
				className={cn(
