...
export type CreatePageNumberRegionModalProps = {
	open: boolean;
	onClose: () => void;
	projectId: string;
	currentPage: number;
...
export const CreatePageNumberRegionModal = ({
	open,
	onClose,
	projectId,
	currentPage,
	documentPageCount,
	drawnBbox,
}: CreatePageNumberRegionModalProps) => {
	...
	const isPending = createRegion.isPending;

	return (
		<Modal
			open={open}
			onClose={handleClose}
			title="Create Page Number Region"
			size="lg"
			footer={
				<>
					...
					{(field) => (
						<Field>
							...
							<Input
								...
								placeholder="e.g., Page Number Top-Right, Page Number Center"
							/>
