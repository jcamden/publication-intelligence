...
import {
	editorSectionsStateAtom,
	moveWindowToFrontAtom,
	updateSectionAtom,
} from "@/app/projects/[projectDir]/editor/_atoms/editor-section-atoms";
import { colorConfigAtom } from "@/app/projects/[projectDir]/editor/_atoms/highlight-atoms";
import {
	projectAccordionExpandedAtom,
	projectSectionOrderAtom,
} from "@/app/projects/[projectDir]/editor/_atoms/sidebar-layout-atoms";
import type { EditorSectionId } from "@/app/projects/[projectDir]/editor/_types/editor-section-types";
...
export const ProjectSidebar = ({
	...
	const sections = useAtomValue(editorSectionsStateAtom);
	...
	const handlePop = ({ id }: { id: EditorSectionId }) => {
